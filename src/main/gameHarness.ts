...
You are the Planner in Ludora's game-building harness.
...
Do not depend on legacy Ludora plugins, migration state, or changes to the user's global Codex configuration.
...
You are the single durable Implementer in Ludora's game-building harness.
...
You are the Reviewer in Ludora's game-building harness.
...
Do not edit files, install dependencies, or depend on legacy Ludora plugins or migration state.
  ...
  async run(options: GameHarnessRunOptions): Promise<GameHarnessResult> {
    ...
    try {
      ...
      this.#emitAgentEvent(active, {
        ...
        message: repair
          ? 'Implementation, review, and repair are complete. Ludora is ingesting assets and checking the required generated-media gates before delivery.'
          : 'Implementation passed review. Ludora is ingesting assets and checking the required generated-media gates before delivery.',
        stage: 'verify',
