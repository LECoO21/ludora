...
try {
  await createWorkspaceTemplate(workspace, {
    id: 'harness-smoke',
    name: 'Harness Smoke',
    idea: 'A temporary project used only to prove the Ludora host harness end to end.',
  ...
  process.stdout.write(
    `Ludora harness smoke passed: ${model.displayName}; review=${result.review.verdict}; repair=${result.repaired}; phases=${phases.join('>')}\n`,
  );
} finally {
